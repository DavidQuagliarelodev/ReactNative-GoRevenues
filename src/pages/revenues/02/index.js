...
export default function Revenues02({ navigation }) {
  return (
    <View style={styles.containerMater}>
      ...
      <View style={styles.containerRevenues}>
        <View style={styles.containerContent}>
          ...
          ></Image>
          <Text style={styles.textImageFood}>Meet</Text>
          ...
          <View style={styles.iconsFormater}>
            <TouchableOpacity style={styles.icons}>
              ...
              ></Image>
              <Text style={styles.textIcons}>20min</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity style={styles.icons}>
              ...
              ></Image>
              <Text style={styles.textIcons}>25cal</Text>
            </TouchableOpacity>
          </View>
